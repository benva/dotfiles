...
inoremap <Right> :echo "No Right for you!"
inoremap <Left> :echo "No Left for you!"
inoremap <F1> :set invfullscreena
map! <D-v> *
nnoremap  :Rg
xmap <nowait>  <Plug>(VM-Find-Subword-Under)
nmap <nowait>  <Plug>(VM-Find-Under)
nnoremap  :GFiles --exclude-standard --others --cached
...
nnoremap <C-F> :Rg
nnoremap <C-P> :GFiles --exclude-standard --others --cached
...
set modelines=0
set ruler
set runtimepath=~/.vim,~/.vim/plugged/nerdtree,~/.vim/plugged/coc.nvim,~/.vim/plugged/vim-visual-multi,~/.vim/plugged/vim-airline,~/.vim/plugged/vim-airline-themes,~/.vim/plugged/vim-fugitive,~/.vim/plugged/fzf,~/.vim/plugged/fzf.vim,~/.vim/plugged/vim-commentary,~/.vim/plugged/gruvbox,~/.vim/plugged/vim-endwise,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vim82/pack/dist/opt/matchit,/usr/share/vim/vimfiles/after,~/.vim/after
set scrolloff=3
set shiftwidth=2
set showcmd
set showmatch
